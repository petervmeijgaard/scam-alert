...
class Deleted extends Event implements ShouldBroadcast
{
    use Dispatchable, InteractsWithSockets, SerializesModels;

    /**
     * @var FacebookScammer The Facebook scammer that has been deleted.
     */
     ...
     *
     * @param FacebookScammer $facebookScammer The Facebook scammer that has been deleted.
     */
